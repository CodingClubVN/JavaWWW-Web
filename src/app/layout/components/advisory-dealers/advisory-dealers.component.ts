    ...
    hoChiMinh: [
      {
        ...
        name: "CODING-CLUB-SHOWROOM HAXACO VÕ VĂN KIỆT",
      ...
      },
      {
        ...
        name: "CODING-CLUB-SHOWROOM HAXACO ĐIỆN BIÊN PHỦ",
      ...
      },
      {
        ...
        name: "CODING-CLUB-SHOWROOM VIETNAM STAR PHÚ MỸ HƯNG",
      ...
      },
      {
        ...
        name: "CODING-CLUB-SHOWROOM VIETNAM STAR TRƯỜNG TRINH ",
    ...
    binhDuong: [
      {
        ...
        name: "CODING-CLUB-SHOWROOM VIET NAM STAR BÌNH DƯƠNG",
    ...
    haNoi: [
      {
        ...
        name: "CODING-CLUB-SHOWROOM HAXACO KIM GIANG",
      ...
      },
      {
        ...
        name: "CODING-CLUB-SHOWROOM HAXACO LÁNG HẠ",
    ...
    haLong: [
      {
        ...
        name: "CODING-CLUB-SHOWROOM AN DU QUẢNG NINH",
